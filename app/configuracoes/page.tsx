      ...
      <Card>
        ...
        <div className="space-y-3 mt-2">
          <div className="flex items-center justify-between py-2 border-b border-[#1A1A1A]">
            ...
            <span className="text-xs font-mono text-[#52525B]">0.1.0</span>
          </div>
          <div className="flex items-center justify-between py-2 border-b border-[#1A1A1A]">
            <span className="text-xs text-[#A1A1AA]">Supabase</span>
            <span className="text-xs font-mono text-[#52525B]">Não configurado</span>
          </div>
          <div className="flex items-center justify-between py-2">
            <span className="text-xs text-[#A1A1AA]">Residências</span>
            <span className="text-xs font-mono text-[#52525B]">3 cadastradas</span>
          </div>
        </div>
      </Card>
    </AppShell>
